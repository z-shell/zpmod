...
# Copilot Instructions for zpmod Repository

## Project Overview

zpmod is a high-performance binary Zsh module that enhances shell script execution through:

1. Automatic compilation of Zsh scripts to optimized bytecode (.zwc files)
2. Comprehensive performance tracking for sourced files
3. Path caching and optimization
4. Integration with the Zi plugin manager
